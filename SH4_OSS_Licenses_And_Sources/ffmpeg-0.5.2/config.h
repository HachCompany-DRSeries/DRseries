...
#define FFMPEG_CONFIGURATION "--enable-cross-compile --cross-prefix=/home/mschreiber/Project/buildroot-2016.05/output/host/usr/bin/sh4a-buildroot-linux-gnu- --sysroot=/home/mschreiber/Project/buildroot-2016.05/output/host/usr/sh4a-buildroot-linux-gnu/sysroot --host-cc=/home/mschreiber/Project/buildroot-2016.05/output/host/usr/bin/ccache /usr/bin/gcc --arch=sh4 --extra-cflags=-fPIC --prefix=/usr --enable-shared --disable-avfilter --disable-vhook --disable-gpl --disable-nonfree --enable-ffmpeg --disable-ffplay --enable-ffserver --disable-postproc --enable-swscale --enable-indevs --enable-outdevs --enable-pthreads --enable-zlib"
