...
FFMPEG_CONFIGURATION=--enable-cross-compile --cross-prefix=/home/mschreiber/Project/buildroot-2016.05/output/host/usr/bin/sh4a-buildroot-linux-gnu- --sysroot=/home/mschreiber/Project/buildroot-2016.05/output/host/usr/sh4a-buildroot-linux-gnu/sysroot --host-cc=/home/mschreiber/Project/buildroot-2016.05/output/host/usr/bin/ccache /usr/bin/gcc --arch=sh4 --extra-cflags=-fPIC --prefix=/usr --enable-shared --disable-avfilter --disable-vhook --disable-gpl --disable-nonfree --enable-ffmpeg --disable-ffplay --enable-ffserver --disable-postproc --enable-swscale --enable-indevs --enable-outdevs --enable-pthreads --enable-zlib
prefix=/usr
...
OPTFLAGS=-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64  -Os  -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -fPIC --sysroot=/home/mschreiber/Project/buildroot-2016.05/output/host/usr/sh4a-buildroot-linux-gnu/sysroot -std=c99 -fomit-frame-pointer -pthread -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -O3 -fno-math-errno -fno-signed-zeros
VHOOKCFLAGS=-fPIC
LDFLAGS=  --sysroot=/home/mschreiber/Project/buildroot-2016.05/output/host/usr/sh4a-buildroot-linux-gnu/sysroot -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
...
HOSTCC=/home/mschreiber/Project/buildroot-2016.05/output/host/usr/bin/ccache /usr/bin/gcc
...
EXTRALIBS=  -lz -lbz2 -pthread -lm -lasound -ldl -lasound -lasound
ARCH=sh4
ARCH_SH4=yes
HAVE_PTHREADS=yes
...
SRC_PATH="/home/mschreiber/Project/buildroot-2016.05/output/build/ffmpeg-0.5.2"
SRC_PATH_BARE=/home/mschreiber/Project/buildroot-2016.05/output/build/ffmpeg-0.5.2
BUILD_ROOT="/home/mschreiber/Project/buildroot-2016.05/output/build/ffmpeg-0.5.2"
