...
"sh-unknown-linux-2.6.24-16-generic" or
	die "Errno architecture (sh-unknown-linux-2.6.24-16-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
