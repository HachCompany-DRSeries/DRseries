...
*/
void fz_run_display_list(fz_display_list *list, fz_device *dev, const fz_matrix *ctm, const fz_rect *area, fz_cookie *cookie, int iMaxImageRawSize, fz_rect *pBlockedImage );
