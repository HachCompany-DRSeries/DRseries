...
Currently available applets include:
	...
	blkid, bunzip2, bzcat, cat, catv, chattr, chcon, chgrp, chmod,
	...
	dumpkmap, echo, egrep, eject, env, ether-wake, expr, false, fbset,
	fdflush, fdformat, fdisk, fgrep, find, flock, fold, free,
	freeramdisk, fsck, fstrim, fuser, getopt, getsebool, getty, grep,
	...
	less, linux32, linux64, linuxrc, ln, load_policy, loadfont,
	loadkmap, logger, login, logname, losetup, ls, lsattr, lsmod, lsof,
	lspci, lsusb, lzcat, lzma, makedevs, matchpathcon, md5sum, mdev,
	...
	readprofile, realpath, reboot, renice, reset, resize, restorecon,
	rm, rmdir, rmmod, route, run-parts, runlevel, sed, selinuxenabled,
	seq, sestatus, setarch, setconsole, setfiles, setkeycodes,
	setlogcons, setsebool, setserial, setsid, sh, sha1sum, sha256sum,
	...
	touch, tr, traceroute, true, truncate, tty, udhcpc, uevent, umount,
