...
case "$perladmin" in
'') perladmin='hico@emdistvm222.localdomain' ;;
esac
...
# archlib='/usr/local/lib/perl5/5.14.2/sh-unknown-linux'
...
# sitearch='/usr/local/lib/perl5/site_perl/5.14.2/sh-unknown-linux'
