...
tie %Config, 'Config', {
    archlibexp => '/usr/local/lib/perl5/5.14.2/sh-unknown-linux',
    archname => 'sh-unknown-linux',
    cc => 'cc',
    d_readlink => 'define',
    d_symlink => 'define',
    dlext => 'so',
    ...
    osname => 'linux',
    osvers => '2.6.24-16-generic',
    path_sep => ':',
    privlibexp => '/usr/local/lib/perl5/5.14.2',
    scriptdir => '/usr/local/bin',
    sitearchexp => '/usr/local/lib/perl5/site_perl/5.14.2/sh-unknown-linux',
