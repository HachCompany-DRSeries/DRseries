Borland C++ Builder 6.0 projects compiling the IPL98 and creating lib-files.
...
ipl98_borland.lib  (release version)
ipl98_borland_d.lib (debug version)
...
ipl98_borland_gui.lib  (release version)
ipl98_borland_guid.lib (debug version)
