			     ...
			     loff_t *offset)
{
	...
	if (raw_copy_to_user(buf, &sample, 4))
		return -EFAULT;
...
static int ltc2440_probe(struct spi_device *spi)
{
	...
	printk("Started probing ltc2440\n\r");
	...
	printk("Finished probing ltc2440\n\r");
...
static const struct of_device_id ltc2440_dt_ids[] = {
        { .compatible = "analog,ltc2440" },
        { }
};
MODULE_DEVICE_TABLE(of, ltc2440_dt_ids);

static const struct spi_device_id ltc2440_id[] = {
        { "ltc2440_adc", 0 },
        { }
};
MODULE_DEVICE_TABLE(spi, ltc2440_id);
