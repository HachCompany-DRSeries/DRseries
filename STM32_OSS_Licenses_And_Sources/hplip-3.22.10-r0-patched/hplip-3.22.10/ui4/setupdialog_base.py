...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.SetupPrintGroupBox = QtGui.QGroupBox(self.page_3)
        self.SetupPrintGroupBox.setCheckable(True)
        self.SetupPrintGroupBox.setObjectName("SetupPrintGroupBox")
        self.gridlayout8 = QtGui.QGridLayout(self.SetupPrintGroupBox)
        self.gridlayout8.setObjectName("gridlayout8")
        self.label_6 = QtGui.QLabel(self.SetupPrintGroupBox)
        self.label_6.setObjectName("label_6")
        self.gridlayout8.addWidget(self.label_6, 0, 0, 1, 1)
        self.PrinterNameLineEdit = QtGui.QLineEdit(self.SetupPrintGroupBox)
        self.PrinterNameLineEdit.setObjectName("PrinterNameLineEdit")
        self.gridlayout8.addWidget(self.PrinterNameLineEdit, 0, 1, 1, 2)
        self.label_7 = QtGui.QLabel(self.SetupPrintGroupBox)
        self.label_7.setObjectName("label_7")
        self.gridlayout8.addWidget(self.label_7, 1, 0, 1, 1)
        self.PrinterDescriptionLineEdit = QtGui.QLineEdit(self.SetupPrintGroupBox)
        ...
        self.label_8 = QtGui.QLabel(self.SetupPrintGroupBox)
        self.label_8.setObjectName("label_8")
        self.gridlayout8.addWidget(self.label_8, 2, 0, 1, 1)
        self.PrinterLocationLineEdit = QtGui.QLineEdit(self.SetupPrintGroupBox)
        ...
        self.label_3 = QtGui.QLabel(self.SetupPrintGroupBox)
        self.label_3.setObjectName("label_3")
        self.gridlayout8.addWidget(self.label_3, 3, 0, 1, 1)
        self.PPDFileLineEdit = QtGui.QLineEdit(self.SetupPrintGroupBox)
        ...
        self.OtherPPDButton = QtGui.QToolButton(self.SetupPrintGroupBox)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.NetworkDiscoveryMethodComboBox.setItemText(0, QtGui.QApplication.translate("Dialog", "mDNS/Bonjour", None, QtGui.QApplication.UnicodeUTF8))
        self.NetworkDiscoveryMethodComboBox.setItemText(1, QtGui.QApplication.translate("Dialog", "SLP", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.SetupPrintGroupBox.setTitle(QtGui.QApplication.translate("Dialog", "Printer Setup", None, QtGui.QApplication.UnicodeUTF8))
